...
abstract class EndlessRecyclerViewScrollListener constructor(var mLayoutManager: RecyclerView.LayoutManager) :
    ...
    public abstract fun onLoadMore(page: Int, totalItemsCount: Int, view: RecyclerView)
